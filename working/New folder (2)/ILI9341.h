...
void ILI9341_Set_CursorPosition(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color);
...
void ILI9341_Draw_Pixel(uint16_t color); //Draw single pixel to ILI9341
...
void LCD_Out(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color);
